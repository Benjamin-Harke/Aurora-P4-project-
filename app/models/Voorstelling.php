...
class Voorstelling {
    ...
    /**
     * Create a new Voorstelling record.
     * @return bool True on success, false on failure.
     */
    public function create() {
        $this->db->query('INSERT INTO voorstelling (medewerker_id, naam, beschrijving, datum, tijd, max_aantal_tickets, beschikbaarheid, is_actief, opmerking) VALUES (:medewerker_id, :naam, :beschrijving, :datum, :tijd, :max_aantal_tickets, :beschikbaarheid, :is_actief, :opmerking)');
